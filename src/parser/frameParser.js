...
import { uncommonUdpPorts } from '../consts'
...
const PCAP_HEADER_MAGIC_NUMBER_B10_LE = 2712847316;
const PCAP_HEADER_MAGIC_NUMBER_B10_BE = 3569595041;

function getSystemEndianness() {
    const buffer = new ArrayBuffer(2);
    const view = new DataView(buffer);
    view.setUint16(0, 0x1234, true); // Write a 16-bit value using little-endian format
...
const readFileHeader = (data) => {
    ...
    console.info('magic number', magicNumber)
...
export const parseFile = (buffer) => {
    ...
    return {fileHeader, frames: allFrames}
}
